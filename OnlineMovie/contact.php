...
<html>
<head>
<title>MovieMaker Template | Contact :: w3layouts</title>
			...
			<div class="footer-top">
				...
				<div class="col_1_of_4 span_1_of_4">
					<div class="textcontact">
						<p>Online Movie management System<br>
						Elif Nur Aslıhan Celepoğlu<br>
						</p>
					</div>
				</div>
				<div class="col_1_of_4 span_1_of_4">
					<div class="call_info">
						<p class="txt_3">e-mail:</p>
						<p class="txt_4">elifcelep511@gmail.com</p>
					</div>
				</div>
				<div class="col_1_of_4 span_1_of_4">
					<div class=social>
